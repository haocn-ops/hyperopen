(ns hyperopen.views.portfolio.optimize.execution-tab
  ...
  standalone Rebalance preview tab was retired; \"Rebalance\" CTAs open this tab
  directly). A dense, phase-aware order list (staged → armed → running → done | halted)
  with a Buys/Sells flow summary, a per-order type editor and an Execution-health
  diagnostics rail.
