...
This document is governed by `/hyperopen/.agents/PLANS.md` and `/hyperopen/docs/PLANS.md`. The tracked work item for this plan is `hyperopen-46t7`; the `bd` issue is historical local tracker context for this plan.
