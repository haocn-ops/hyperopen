...
This document is governed by `/hyperopen/.agents/PLANS.md` and `/hyperopen/docs/PLANS.md`. The tracked work item for this plan is `hyperopen-k63w`; the `bd` issue is historical local tracker context from the active phase.
