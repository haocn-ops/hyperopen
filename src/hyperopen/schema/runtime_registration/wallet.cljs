...
(def effect-binding-rows
  [[:effects/connect-wallet :connect-wallet]
   ...
   [:effects/approve-builder-fee :approve-builder-fee]
...
(def action-binding-rows
  [[:actions/connect-wallet :connect-wallet-action]
   ...
   [:actions/request-builder-fee-review :request-builder-fee-review]
   [:actions/confirm-builder-fee-review :confirm-builder-fee-review]])
