...
def policyCorpus : List (String × Policy) :=
  ...
  ,("actions/margin-rec-process-intents", defaultPolicy true ["effects/api-submit-position-margin"])
  ,("actions/margin-rec-sync", defaultPolicy true ["effects/fetch-candle-snapshot", "effects/margin-rec-compute", "effects/margin-rec-fetch-fills"])
