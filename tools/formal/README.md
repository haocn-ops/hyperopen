...
- `portfolio-returns-normalization`: modeled, emits `target/formal/portfolio-returns-normalization-vectors.cljs`, and syncs `test/hyperopen/formal/portfolio_returns_normalization_vectors.cljs`
