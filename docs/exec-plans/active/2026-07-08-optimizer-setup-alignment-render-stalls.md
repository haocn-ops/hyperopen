...
- [ ] Owner confirmation on the real wallet/profile (with the stored assumption libraries): goal-card clicks feel instant and the web-vitals panel LCP/CLS improve from 6.07 s / 0.81.
