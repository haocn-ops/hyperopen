...
This document is maintained in accordance with `/hyperopen/.agents/PLANS.md` and `/hyperopen/docs/PLANS.md`. The tracked `bd` work is `hyperopen-k7lr`, and `bd` was the local tracker used at the time while this plan records the implementation story.
